            ...
            <div class="ibox-content">
            	<form class="form-horizontal m-t" id="managerForm">
	                ...
	                <div class="form-group">
	                    ...
	                    <div class="col-sm-8">
	                        <input id="account" name="account" value="${manager.account }" placeholder="请输入管理员账号" type="text" class="form-control" aria-required="true">
	                    </div>
	                </div>
	                <div class="form-group">
	                    <label class="col-sm-3 control-label">密码：</label>
	                    <div class="col-sm-8">
	                        <input id="mPassword" name="mPassword" value="${manager.mPassword }" placeholder="请输入密码" type="password" class="form-control" aria-required="true">
	                    </div>
	                </div>
	                <div class="form-group">
	                    <label class="col-sm-3 control-label">确认密码：</label>
	                    <div class="col-sm-8">
	                        <input id="mPassword2" name="mPassword2" value="${manager.mPassword }" placeholder="请请再次输入密码"  equalTo="#mPassword" type="password" class="form-control" aria-required="true">
	                    </div>
	                </div>
	                <div class="form-group">
						<label class="col-sm-3 control-label">权限：</label>
						<div class="col-sm-8">
							<select id="permission" name="permission" class="form-control" aria-required="true" placeholder="请选择权限">
    ...
    <script>
	    ...
	    var resetting = function(){
	    	...
	    	$.ajax({
		        type: 'POST',
		        async: false,
		        url: 'manage/manager/getManager.shtml',
		        data: {
		            "managerId": managerId,
		        },
