            ...
            <div class="ibox-content">
            	<form class="form-horizontal m-t" id="equipmentForm">
	                <div class="form-group">
	                    ...
	                    <div class="col-sm-8">
	                        <input id="equipmentId" name="equipmentId" type="text" class="form-control" placeholder="请输入设备编号">
	                    </div>
	                </div>
	                <div class="form-group">
	                    <label class="col-sm-3 control-label">生产商：</label>
	                    <div class="col-sm-8">
	                        <input id="manufacturer" name="manufacturer" type="text" class="form-control" placeholder="请输入生产商">
	                    </div>
	                </div>
	                 <div class="form-group">
	                    ...
	                    <div class="col-sm-8">
	                       <select id="type" name="type" class="form-control"
								aria-required="true" placeholder="请选择设备类型">
	                 ...
	                 <div class="form-group">
	                    ...
	                    <div class="col-sm-8">
	                        <input id="version" name="version" type="text" class="form-control"placeholder="请输入型号">
	                    </div>
	                </div>
	        ...
	        $("#equipmentForm").validate({
	            ...
	            messages: {
	            	equipmentId: {
	            		...
	            		maxlength: icon + "设备编号不能超过20个字符"
	            	},
	            	manufacturer: {
	            		required: icon + "请输入生产商",
	            		maxlength: icon + "生产商不能超过10个字符"
	            	},
	                type: {
