        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
            	<div class="col-sm-6 float-left">	
	            	<a href="manage/repair/repairListUI.shtml" class="btn btn-w-m btn-info" type="button"><i class="fa fa-mail-reply" aria-hidden="true"></i>&nbsp;返回</a>
            	</div>
                <table id="allRepairList" data-toggle="table"
					data-url="manage/repair/getAllRepairList.shtml"
