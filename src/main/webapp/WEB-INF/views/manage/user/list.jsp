        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
            	<div class="col-sm-6 float-left">	
	            	<a href="manage/user/allUserListUI.shtml" class="btn btn-w-m btn-info" type="button"><i class="fa fa-tasks" aria-hidden="true"></i>&nbsp;查看用户记录</a>
            	</div>
                <table id="userList" data-toggle="table"
					data-url="manage/user/getUserList.shtml"
    ...
    <script>
	    function actionFormatter(value, row, index) {	    	
	    	return ['<a class="btn btn-primary btn-xs" id="detail" type="button"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp;详情</a>',
	    			'&nbsp;&nbsp;',
	    			'<a class="btn btn-primary btn-xs" id="agree" type="button"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i>&nbsp;同意</a>',
	    			'&nbsp;&nbsp;',
