	...
	<div class="wrapper wrapper-content animated fadeInRight">
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				<form class="form-horizontal m-t" id="repairForm">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label">设备问题：</label>
						<div class="col-sm-8">
						 <textarea  id="problem" name="problem" placeholder="请输入设备问题" class="form-control" rows="3"aria-required="true"></textarea>
									...
									.validate(
											{
												...
												messages : {
													...
													equipmentId : {
														required : icon + "请选择设备编号"
													},
													problem : {
														required : icon + "请输入设备问题",
														maxlength : icon + "设备问题不能超过200个字符",
														minlength : icon + "设备问题不能少于10个字符"
																
													}
												},
												submitHandler : function(form) {
													$.post("customer/repair/saveRepair.shtml",decodeURIComponent($(form).serialize(),true),function(data) {
