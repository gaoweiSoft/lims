        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
            	<div class="col-sm-6 float-left">	
	            	<a href="customer/apply/applyAddUI.shtml" class="btn btn-w-m btn-info" type="button"><i class="fa fa-tasks" aria-hidden="true"></i>&nbsp;申请使用设备</a>
            	</div>
                <table id="applyList" data-toggle="table"
					data-url="customer/apply/getApplyList.shtml"
